# biGENIUS Example Project for Dimensional MSSQL Example

This is an example project for dimensional MSSQL for the biGENIUS-X application. This repository should give a quick introduction to dimensional modeling in MSSQL.
